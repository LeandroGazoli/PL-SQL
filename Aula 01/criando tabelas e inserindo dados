...
-- selecinar todos os elementos da tabela ( asteristico serve para indicar que queremos todos os dados da tabela alunos.)    
SELECT * FROM taluno;

--DROP TABLE nome_tabela; --DELETAR TABELA 

--Sequence
-- criar uma sequencia que comece no 1 usando como referencia SEQ_ALUNO para me referir a tabela de alunos
CREATE SEQUENCE SEQ_ALUNO START WITH 1;

-- SEQ_ALUNO.NEXTVAL = Sequencia do SEQ ALUNO + NEXTVAL (PROXIMO VALOR) OU SEJA 1,2,3,4... RESPECTIVAMENTE
-- Tipos de insert para adicionar dados na tabela:

INSERT INTO TALUNO (COD_ALUNO, NOME, CIDADE, CEP)
VALUES (SEQ_ALUNO.NEXTVAL, 'MARCIO', 'NOVO HAMBURGO', '93000000');

INSERT INTO TALUNO(COD_ALUNO,NOME,CIDADE,CEP)
VALUES  (SEQ_ALUNO.NEXTVAL,'PAULA','IVOTI','93000000');

INSERT INTO TALUNO(COD_ALUNO,NOME,CIDADE,CEP) VALUES  (SEQ_ALUNO.NEXTVAL,'MARIA','SAPIRANGA','93000000');
...
-- inserindo valores na tabela TCURSO sem indicar o nome dos campos (basicamente fazemos que nem uma array)
...
--sysdate pega a hora atual do servidor
...
INSERT INTO TALUNO(COD_ALUNO,NOME,CIDADE,CEP)
VALUES (SEQ_ALUNO.NEXTVAL,'ANSDRE','IVOSTI','120S00000');
...
CREATE TABLE TITEM
 ( COD_ITEM INTEGER NOT NULL PRIMARY KEY,
   ...
   VALOR NUMBER(8,2) );
   -- valor entre "VALOR NUMBER (8,2)" indica que temos um campo com 8 casas sendo delas 2 para decimais, ou seja temos 6 campos inteiro e 2 decimais somando 8
...
--Uper deixa as letras maiusculas
