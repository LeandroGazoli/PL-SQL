...
-- default estado sempre RS
ALTER TABLE TALUNO ADD ESTADO CHAR(2) DEFAULT 'RS';
-- default SALARIO SEMPRE 620
...
UPDATE taluno set
nascimento='10/08/2000 22:00:00'
WHERE COD_ALUNO=3;
--
SELECT * FROM TALUNO;

-- trunc arredonda os numeros, usando na data, ele ignora a hora. pois o campo de data guarda xx/xx/xxxx xx:xx:xx
SELECT COD_ALUNO, trunc(NASCIMENTO), NASCIMENTO AS nascimento, NOME
FROM TALUNO
WHERE trunc(NASCIMENTO) = '15/08/2000';

--BETWEEN (Esteja entre)
SELECT COD_ALUNO, NASCIMENTO, Trunc(NASCIMENTO), NOME
FROM TALUNO
WHERE NASCIMENTO
 BETWEEN TO_DATE('25/08/2010 ','DD/MM/YYYY HH24:MI')
  AND TO_DATE('25/08/2018','DD/MM/YYYY HH24:MI');
